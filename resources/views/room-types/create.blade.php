    ...
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <i class='bx bx-category-alt me-2 text-primary'></i> {{ __('Yeni Oda Tipi Ekle') }}
            </h2>
                        ...
                        <div class="card-header bg-white py-3 border-bottom">
                            <div class="d-flex align-items-center">
                                <div class="avatar avatar-md bg-primary-subtle rounded-circle me-3 d-flex align-items-center justify-content-center">
                                    <i class='bx bx-plus-circle fs-4 text-primary'></i>
                                </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <form method="POST" action="{{ route('room-types.store') }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control @error('base_price') is-invalid @enderror" 
                                                id="base_price" name="base_price" value="{{ old('base_price', 1000) }}" 
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                                ...
                                                placeholder="Oda tipi hakkında detaylı bilgi">{{ old('description') }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="d-flex justify-content-end mt-4">
                                    <a href="{{ route('room-types.index') }}" class="btn btn-outline-secondary me-2">
